...
const Faqs=(props)=>{
    ...
    // ]   let data=[
    //     {question:"What is the luggage I am allowed to bring? Weight? Size? And how many?",
    //         answer:"1 carry-on bag total dimensions of 49.5 linear inches (length + width + height) with a\n" +
